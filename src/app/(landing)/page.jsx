        ...
        <div className="bg-[#1d232a]">
            ...
            <div className="text-center text-white text-3xl py-10 font-bold flex items-center max-w-7xl mx-auto gap-6">
                <div>
                    ...
                    <p className="text-lg">
                        Découvrez nos plats exquis préparés avec les ingrédients les plus frais et
                        de la plus haute qualité. Nos chefs talentueux mettent tout leur
                        savoir-faire et leur passion dans chaque plat pour vous offrir une
                        expérience culinaire inoubliable. Que vous préfériez les entrées délicates,
                        les plats principaux savoureux ou les desserts décadents, notre menu a
                        quelque chose à ravir tous les palais.
                    </p>
                </div>
            ...
            <div className="text-center text-white text-3xl py-10 font-bold flex items-center max-w-7xl mx-auto gap-6">
                ...
                <div>
                    ...
                    <p className="text-lg">
                        ...
                        optimale et une saveur inégalée. Nos chefs s'engagent à respecter les normes
                        les plus élevées en matière de préparation et de présentation des plats,
                        vous assurant ainsi une expérience culinaire exceptionnelle à chaque visite.
                    </p>
                </div>
            </div>
        </div>
